    ...
    QGCFlickable {
        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                Layout.alignment: Qt.AlignHCenter
                Layout.preferredWidth: _summaryRoot._overviewChecklistWidth
                color: clusterEntryMouseArea.pressed
                    ? _summaryRoot._cardPressedColor
                    : (clusterEntryMouseArea.containsMouse ? _summaryRoot._cardHoverColor : _summaryRoot._cardBaseColor)
                radius: _summaryRoot._cardCornerRadius
                border.width: 1
                border.color: _summaryRoot._cardBorderColor
                implicitHeight: clusterEntryContent.implicitHeight + (_summaryRoot._cardPadding * 2)
                ...
                MouseArea {
                    ...
                    onClicked: {
                        if (typeof mainWindow !== "undefined"
                                && mainWindow
                                && typeof mainWindow.showClusterView === "function") {
                            mainWindow.showClusterView()
                        }
                    }
                }

                ColumnLayout {
                    id: clusterEntryContent
                    ...
                    RowLayout {
                        ...
                        Rectangle {
                            ...
                            color: _summaryRoot._cardIconChipColor
                            border.width: 1
                            border.color: _summaryRoot._cardBorderColor
                        ...
                        ColumnLayout {
                            ...
                            QGCLabel {
                                Layout.fillWidth: true
                                wrapMode: Text.WordWrap
                                text: qsTr("Open the independent cluster integration workspace without adding a new top tab or changing Fly and map modules.")
                                color: _summaryRoot._cardSecondaryTextColor
                                font.pointSize: ScreenTools.defaultFontPointSize * 0.92
                            }
                        }
                        ...
                        Rectangle {
                            Layout.alignment: Qt.AlignVCenter
                            radius: ScreenTools.defaultFontPixelHeight * 0.45
                            color: _summaryRoot._cardAccentColor
                            implicitHeight: ScreenTools.defaultFontPixelHeight * 1.3
                            implicitWidth: openClusterLabel.implicitWidth + (ScreenTools.defaultFontPixelWidth * 1.6)
