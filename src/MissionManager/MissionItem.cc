...
MissionItem::MissionItem(QObject* parent)
    ...
    , _param1Fact                   (0, QStringLiteral("参数1:"),       FactMetaData::valueTypeDouble)
    , _param2Fact                   (0, QStringLiteral("参数2:"),       FactMetaData::valueTypeDouble)
    , _param3Fact                   (0, QStringLiteral("参数3:"),       FactMetaData::valueTypeDouble)
    , _param4Fact                   (0, QStringLiteral("参数4:"),       FactMetaData::valueTypeDouble)
    , _param5Fact                   (0, QStringLiteral("纬度:"),        FactMetaData::valueTypeDouble)
    , _param6Fact                   (0, QStringLiteral("经度:"),        FactMetaData::valueTypeDouble)
    , _param7Fact                   (0, QStringLiteral("高度:"),        FactMetaData::valueTypeDouble)
{
...
MissionItem::MissionItem(int             sequenceNumber,
    ...
    , _param3Fact                   (0, QStringLiteral("参数3:"),       FactMetaData::valueTypeDouble)
    , _param4Fact                   (0, QStringLiteral("参数4:"),       FactMetaData::valueTypeDouble)
    , _param5Fact                   (0, QStringLiteral("纬度/X:"),      FactMetaData::valueTypeDouble)
    , _param6Fact                   (0, QStringLiteral("经度/Y:"),      FactMetaData::valueTypeDouble)
    , _param7Fact                   (0, QStringLiteral("高度/Z:"),      FactMetaData::valueTypeDouble)
{
    // Need a good command and frame before we start passing signals around
    _commandFact.setRawValue(MAV_CMD_NAV_WAYPOINT);
    _frameFact.setRawValue(MAV_FRAME_GLOBAL_RELATIVE_ALT);
